...
public class EndCityProximityPlacementModifier extends PlacementModifier {
    ...
    public Stream<BlockPos> getPositions(DecoratorContext context, Random random, BlockPos pos) {
        ...
        boolean withinEndCity = context.getGenerator().method_41053(BuiltInStructureSets.END_CITIES, context.getWorld().getSeed(), chunk.x, chunk.z, distance.get(context.getWorld().getRandom()));
